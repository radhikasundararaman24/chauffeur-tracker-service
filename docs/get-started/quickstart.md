...
Let’s test making this simple request to the [`schedules`](../reference/schedules.md) resource.  You’ll use cURL to make the API call, and for Basic Auth, include the -u parameter to pass the username and password and return the response without errors.
